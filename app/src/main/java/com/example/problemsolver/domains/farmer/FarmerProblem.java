...
public class FarmerProblem extends Problem {
    ...
    private static final String INTRO =
            "A farmer and his wolf, goat, and cabbage come to the edge of a" +
                    ...
                    " if the goat is left with the cabbage, the goat will eat the cabbage. Devise a sequence of crossings of the river " +
                    "so that all four characters arrive safely on the other side.";
