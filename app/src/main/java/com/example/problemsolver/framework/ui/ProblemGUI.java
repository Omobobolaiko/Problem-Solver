...
public class ProblemGUI {
    public ProblemGUI(Problem problem, TextView startView, TextView goalView, LinearLayout movesView, TextView countView, TextView message, Button resetButton, Button solvebutton, Button nextButton, LinearLayout controls, TextView stats) {
